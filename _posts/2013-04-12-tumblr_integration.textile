...
<!-- vimeo: # -->
category : Code
tags : [code, tumblr, embed, api, javascript]
published : true
portfolio : false
---
...
to anywhere an unstyled but HTML-formatted tumblr dump to show up on your side, and style the output however you want with CSS.

"Here's the JS":http://funkability.tumblr.com/js and "Here's the HTML":/assets/posts/tumblr-integration.html

it looks nice if you want a simple feed on your site, for example if your main page only consists of your tumblr blog, or if you have a separate page dedicated to your tumblr. 

But it's hard to work with, since can't customize the content and output easily. You don't get any meta-data, and you can't control the number of returned, and so on, making it hard to create controls like pagination or infinite scroll.
...
Next, I'm going to integrate Tumblr into my Jekyll blog feed, then have a writeup a few Javascript parsing functions to pretty-fy and make the output a bit easier to use, and examples on how to integrate.