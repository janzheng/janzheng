...
preview-img : /assets/posts/lets-run/preview.png
preview-height : 200
preview-look : light
published : true
portfolio : no
...
"!/assets/posts/lets-run/1.png!":http://janzheng.com/LetsRun
...
Check out "(project-link).Let's Run!":http://janzheng.com/LetsRun