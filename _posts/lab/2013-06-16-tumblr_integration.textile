...
<script type="text/javascript" src="http://funkability.tumblr.com/js"></script>
...
http://funkability.tumblr.com/api/read
...
{% highlight html linenos %} 
tumblr_api_read 
{% endhighlight %}. Cool! Here's "the JSON output of my blog":http://funkability.tumblr.com/api/read/json/. Notice how we have a much richer set of metadata using this method.
...
As an example, here is a link dynamically pulled in from Tumblr to
