...
<!-- vimeo: # -->
<!-- 
header-img: http://placekitten.com/1200/300
header-styles: article--head-light
 -->
...
<figure><a href="#">!{{page.source}}/codepen.png!</a><figcaption>look, blocks on blocks!</figcaption>
...
<figure class="figure-wide"><a href="#">!{{page.source}}/24-grid.png!</a><figcaption>my slightly messier but more flexible 24-column grid. Here's an example of <a href="{{page.source}}/layout.html">how it will work</a>
</figcaption>
