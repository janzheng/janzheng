...
<head>
  ...
  <title>How to Embed Tumblr Without a Server</title>
    ...
    <div 
      ...
      >
        <div class="article__head__intro" >
          ...
          <div class="article__head__category article__head__category__lab" >

            <!-- <div class="article__head__category__icon"> -->

              
                
<svg class="svg--lab" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
...
<svg class="svg--lab" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve"> <path id="flask-7-icon" d="M253.984,164.94c0,11.354-9.205,20.56-20.56,20.56s-20.559-9.205-20.559-20.56s9.204-20.559,20.559-20.559S253.984,153.586,253.984,164.94z M286.241,66.82c0,9.289-7.531,16.82-16.821,16.82s-16.821-7.531-16.821-16.82c0-9.291,7.531-16.82,16.821-16.82S286.241,57.529,286.241,66.82z M294.34,161.617c-15.916,0-28.865-12.948-28.865-28.864c0-15.917,12.949-28.865,28.865-28.865s28.865,12.948,28.865,28.865C323.205,148.669,310.256,161.617,294.34,161.617z M217.471,126.212c-13.567,0-24.606-11.04-24.606-24.608s11.039-24.607,24.606-24.607c13.569,0,24.608,11.039,24.608,24.607S231.041,126.212,217.471,126.212z M339.707,462H172.293c-22.671,0-37.592-23.729-27.767-44.16l47.632-99.066c13.254-27.564,20.136-57.76,20.136-88.346v-19.641h29.174c0,20.844,2.479,58.704-16.161,105.529h40.978l52.064,109.282c5.748,12.02,22.731,5.53,16.778-6.839c-5.347-11.105-15.295-32.198-41.766-87.253c-26.389-54.882-22.874-99.906-22.874-120.72h29.217v19.641c0,30.586,6.882,60.781,20.136,88.347l47.633,99.064C377.298,438.271,362.379,462,339.707,462z"></path> </svg> -->
        ...
        <div class="article__head__title__container" >
          <div class="article__head__title">How to Embed Tumblr Without a Server</div>
        </div> 

        <div class="article__head__subtitle__container" >
          <div class="article__head__subtitle">How to easily add Tumblr to a static site, without PHP, a server, or any server-side code</div>
        </div> 
    ...
    <div class="article__body container">
      ...
      <div class="article--summary-container">
        <div class="article--summary">How to easily add Tumblr to a static site, without PHP, a server, or any server-side code</div>
      </div>  -->
      ...
      <div class="article__body__content">
        p(dropcap). I've recently started "funkability":http://funkability.tumblr.com, a Tumblr usability and interaction design feed I'll probably get around to updating twice a year. [Edit 1/7/2014: my predictions were spot on!]
...
<figure class="highlight"><pre><code class="language-html" data-lang="html"><span class="lineno">1</span> <span class="nt">&lt;script </span><span class="na">type=</span><span class="s">&quot;text/javascript&quot;</span> <span class="na">src=</span><span class="s">&quot;http://funkability.tumblr.com/js&quot;</span><span class="nt">&gt;&lt;/script&gt;</span></code></pre></figure>
...
"Here's what the tumblr dump looks like":/app/posts/idea/tumblr-integration/tumblr-integration.html
...
<figure class="highlight"><pre><code class="language-html" data-lang="html"><span class="lineno">1</span> http://funkability.tumblr.com/api/read
<span class="lineno">2</span> http://funkability.tumblr.com/api/read?start=0<span class="err">&amp;</span>num=1
<span class="lineno">3</span> http://funkability.tumblr.com/api/read?start=0<span class="err">&amp;</span>num=1<span class="err">&amp;</span>type=text</code></pre></figure>
...
<figure class="highlight"><pre><code class="language-html" data-lang="html"><span class="lineno">1</span> <span class="nt">&lt;pre</span> <span class="na">class=</span><span class="s">&quot;prettyprint&quot;</span><span class="nt">&gt;&lt;script </span><span class="na">type=</span><span class="s">&quot;text/javascript&quot;</span> <span class="na">src=</span><span class="s">&quot;http://username.tumblr.com/api/read/json&quot;</span><span class="nt">&gt;&lt;/script&gt;</span>
<span class="lineno">2</span> <span class="nt">&lt;/pre&gt;</span></code></pre></figure>



This snippet assigns a JSON object of your entire blog to a new variable called 

<figure class="highlight"><pre><code class="language-html" data-lang="html"><span class="lineno">1</span>  
<span class="lineno">2</span> tumblr_api_read </code></pre></figure> Cool! Here's "the JSON output of my blog":http://funkability.tumblr.com/api/read/json/. Notice how we have a much richer set of metadata using this method.
...
<figure class="highlight"><pre><code class="language-html" data-lang="html"><span class="lineno">1</span>   
<span class="lineno">2</span> tumblr_api_read[&#39;posts&#39;][0][&#39;url&#39;]</code></pre></figure>
...
<figure class="highlight"><pre><code class="language-html" data-lang="html"><span class="lineno">1</span> <span class="nt">&lt;script </span><span class="na">type=</span><span class="s">&quot;text/javascript&quot;</span><span class="nt">&gt;</span>
<span class="lineno">2</span>     <span class="c1">// The variable &quot;tumblr_api_read&quot; is now set to your tumblr feed.</span>
<span class="lineno">3</span>     <span class="nb">document</span><span class="p">.</span><span class="nx">write</span><span class="p">(</span>
<span class="lineno">4</span>         <span class="s1">&#39;&lt;a href=&quot;&#39;</span> <span class="o">+</span> <span class="nx">tumblr_api_read</span><span class="p">[</span><span class="s1">&#39;posts&#39;</span><span class="p">][</span><span class="mi">0</span><span class="p">][</span><span class="s1">&#39;url&#39;</span><span class="p">]</span> <span class="o">+</span> 
<span class="lineno">5</span>         <span class="s1">&#39;&quot;&gt;My most recent Tumblr post&lt;/a&gt;&#39;</span>
<span class="lineno">6</span>     <span class="p">);</span>
<span class="lineno">7</span> <span class="nt">&lt;/script&gt;</span></code></pre></figure>
...
<figure class="highlight"><pre><code class="language-html" data-lang="html"><span class="lineno">1</span> <span class="nt">&lt;script </span><span class="na">type=</span><span class="s">&quot;text/javascript&quot;</span> <span class="na">src=</span><span class="s">&quot;http://funkability.tumblr.com/api/read/json&quot;</span><span class="nt">&gt;&lt;/script&gt;</span>
...
<span class="lineno">3</span> <span class="nb">document</span><span class="p">.</span><span class="nx">write</span><span class="p">(</span><span class="s1">&#39;&lt;a href=&quot;&#39;</span> <span class="o">+</span> <span class="nx">tumblr_api_read</span><span class="p">[</span><span class="s1">&#39;posts&#39;</span><span class="p">][</span><span class="mi">0</span><span class="p">][</span><span class="s1">&#39;url&#39;</span><span class="p">]</span> <span class="o">+</span> <span class="s1">&#39;&quot;&gt;my most recent Tumblr post.&lt;/a&gt;&#39;</span><span class="p">);</span>
<span class="lineno">4</span> <span class="nt">&lt;/script&gt;</span></code></pre></figure>
