...
<figure class="highlight"><pre><code class="language-html" data-lang="html"><table style="border-spacing: 0"><tbody><tr><td class="gutter gl" style="text-align: right"><pre class="lineno">1</pre></td><td class="code"><pre><span class="nt">&lt;script </span><span class="na">type=</span><span class="s">"text/javascript"</span> <span class="na">src=</span><span class="s">"http://funkability.tumblr.com/js"</span><span class="nt">&gt;&lt;/script&gt;</span><span class="w">
...
2
3</pre></td><td class="code"><pre>http://funkability.tumblr.com/api/read
http://funkability.tumblr.com/api/read?start=0<span class="err">&amp;</span>num=1
http://funkability.tumblr.com/api/read?start=0<span class="err">&amp;</span>num=1<span class="err">&amp;</span>type=text<span class="w">
</span></pre></td></tr></tbody></table></code></pre></figure>
...
<figure class="highlight"><pre><code class="language-html" data-lang="html"><table style="border-spacing: 0"><tbody><tr><td class="gutter gl" style="text-align: right"><pre class="lineno">1
2</pre></td><td class="code"><pre><span class="nt">&lt;pre</span> <span class="na">class=</span><span class="s">"prettyprint"</span><span class="nt">&gt;&lt;script </span><span class="na">type=</span><span class="s">"text/javascript"</span> <span class="na">src=</span><span class="s">"http://username.tumblr.com/api/read/json"</span><span class="nt">&gt;&lt;/script&gt;</span>
<span class="nt">&lt;/pre&gt;</span><span class="w">
</span></pre></td></tr></tbody></table></code></pre></figure>
...
<figure class="highlight"><pre><code class="language-html" data-lang="html"><table style="border-spacing: 0"><tbody><tr><td class="gutter gl" style="text-align: right"><pre class="lineno">1
2</pre></td><td class="code"><pre> 
tumblr_api_read <span class="w">
</span></pre></td></tr></tbody></table></code></pre></figure> Cool! Here's "the JSON output of my blog":http://funkability.tumblr.com/api/read/json/. Notice how we have a much richer set of metadata using this method.
...
<figure class="highlight"><pre><code class="language-html" data-lang="html"><table style="border-spacing: 0"><tbody><tr><td class="gutter gl" style="text-align: right"><pre class="lineno">1
2</pre></td><td class="code"><pre>  
tumblr_api_read['posts'][0]['url']<span class="w">
</span></pre></td></tr></tbody></table></code></pre></figure>
...
7</pre></td><td class="code"><pre><span class="nt">&lt;script </span><span class="na">type=</span><span class="s">"text/javascript"</span><span class="nt">&gt;</span>
    <span class="c1">// The variable "tumblr_api_read" is now set to your tumblr feed.</span>
    <span class="nb">document</span><span class="p">.</span><span class="nx">write</span><span class="p">(</span>
        <span class="s1">'&lt;a href="'</span> <span class="o">+</span> <span class="nx">tumblr_api_read</span><span class="p">[</span><span class="s1">'posts'</span><span class="p">][</span><span class="mi">0</span><span class="p">][</span><span class="s1">'url'</span><span class="p">]</span> <span class="o">+</span> 
        <span class="s1">'"&gt;My most recent Tumblr post&lt;/a&gt;'</span>
    <span class="p">);</span>
...
2
3
4</pre></td><td class="code"><pre><span class="nt">&lt;script </span><span class="na">type=</span><span class="s">"text/javascript"</span> <span class="na">src=</span><span class="s">"http://funkability.tumblr.com/api/read/json"</span><span class="nt">&gt;&lt;/script&gt;</span>
