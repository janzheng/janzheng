...
<div class="timeline">
  ...
  <ul class="timeline__list">
    ...
    <div class="sticky-item" >
      <div class="timeline__year sticky-content">2015</div>
    </div>
      ...
      <li class="timeline__item expandablejs">
        <div class="timeline__preview expandablejs--preview">
          ...
          <div class="timeline__headline">
            ...
            <div>
              ...
              <span class="timeline__date">2015 &mdash; current</span>
            </div>
        ...
        <div class="timeline__full expandablejs--full">
          <p>At Ubiquiti Networks I am currently designing and developing new customer-facing support and community tools that will launch at the end of 2015.</p>
        </div>
      </li>
