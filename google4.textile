...
Scroll effects could be applied to certain assets like the homepage asset, or personalize asset for slight animation effects, like the sliders in Section 5 (Personalization) for example. "Example from The Verge":http://www.theverge.com/2013/6/11/4418188/apple-ios-7-design-influences (scroll down to the large row of iPhones)  
